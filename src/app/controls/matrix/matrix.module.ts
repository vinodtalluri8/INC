...
//import { MatrixTabComponent } from './matrix-tab-component/matrix-tab/matrix-tab.component';
...
@NgModule({
  ...
  declarations: [MatrixComponent, GeneralMatrixInfoComponent, MatrixTabComponent, RiskAssessmentComponent, BusinessActivityComponent, ControlComponent, ControlEvidenceComponent, BusinessProcessComponent]
})
